...
/*todo 3
    Не смогла решить сама, разбирала решение преподавателя!
    ***
    Дан массив чисел. Найти число состоящее из собственных делителей.
    которое делится на все числа, из которого оно состоит.
    Например число 128 состоит из 1 2 и 8.
    128 % 1 == 0 , 128 % 2 == 0 и 128 % 8 == 0.
 */
